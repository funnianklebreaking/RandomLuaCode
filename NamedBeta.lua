...
╭━╮╱╭╮╱╱╱╱╱╱╱╱╱╱╭╮╭━━━╮╱╭╮            |
┃┃╰╮┃┃╱╱╱╱╱╱╱╱╱╱┃┃┃╭━╮┃╱┃┃            |
┃╭╮╰╯┣━━┳╮╭┳━━┳━╯┃┃┃╱┃┣━╯┣╮╭┳┳━╮     | Welcome to the Named Admin source, feel free to take a look around.
┃┃╰╮┃┃╭╮┃╰╯┃┃━┫╭╮┃┃╰━╯┃╭╮┃╰╯┣┫╭╮╮    | Enjoy.
┃┃╱┃┃┃╭╮┃┃┃┃┃━┫╰╯┃┃╭━╮┃╰╯┃┃┃┃┃┃┃┃    |
╰╯╱╰━┻╯╰┻┻┻┻━━┻━━╯╰╯╱╰┻━━┻┻┻┻┻╯╰╯    |
--]]
 ...
 Notify({
		 Description = "This version is unofficial discord.gg/9Dn6Td5xzz";
		 Title = "Message from Captain Cheese";
		 Duration = 5;
 ...
 if FileSupport then
 if not isfolder('Named-Admin') then
 makefolder('Named-Admin')
 end
 
 if not isfolder('Named-Admin/Plugins') then
	 makefolder('Named-Admin/Plugins')
 end
 
 if not isfile("Named-Admin/Prefix.txt") then
 writefile("Named-Admin/Prefix.txt", ';')
 else
 end
 end
 ...
 local opt = {
	 prefix = readfile("Named-Admin/Prefix.txt", ';'), -- If player's executor has the custom file function support it reads the prefix file to get prefix
 ...
 cmd.add({"plugins"}, {"plugins", "Check what kind of plugins you have, add plugins using a gui, delete a plugin."}, function()
	 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/FE/main/NamedAdminPlugin"))();
 end)
 ...
 writefile("Named-Admin\\Prefix.txt", PrefixChange)
 opt.prefix = PrefixChange
 Notify({
...
print(Time)
 ...
 Notify({
	 Description = "Named Admin currently has ".. commandcount .. " commands";
	 Title = "Named Admin";
	 Duration = 5;
...
if b:IsA("Folder") then
 ...
 cmd.add({"admin"}, {"admin", "whitelist someone to allow them to use commands"}, function(...)
	 ...
	 if Player ~= nil and not Admin[Player.UserId] then
		 ...
		 ChatMessage("/w "..Player.Name.." [Named Admin] You've got admin. Prefix: ';'")
		 wait(0.2)
		 ChatMessage("/w "..Player.Name.." [Named Admin Commands] glue, unglue, fling, fling2, spinfling, unspinfling, fcd, fti, fpp, fireremotes, holdhat")
...
-- [[ THANKS TO LIGHTING BOLT FOR THIS ]] --
 ...
 speed = (...)
	 ...
	 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
		 ...
		 Notify({
		 Description = "Named Admin has detected you using mobile you now have a mfly button click it to enable / disable mobile flying (For easier use)";
		 Title = "Named Admin";
		 Duration = 5;
		 });
...
game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest:FireServer(A_1,A_2)
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NamedAdmin/main/AnimationSpoofer"))()
 end)
...
print(text)
 ...
 TextLabel_2.Text = "You are executing an anti-chat-log script meaning that Named Admin wouldnt be able to detect when you have chatted meaning if you are on mobile and use the chat to execute commands it wont work. Are you sure you want to execute this?"
...
getChar().HumanoidRootPart.CFrame = target.Character.Humanoid.RootPart.CFrame
 ...
 cmd.add({"watch", "view", "spectate"}, {"view <player>", "Watch the given player"}, function(...)
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NamedAdmin/main/pp"))()
 end)
 ...
 cmd.add({"discord"}, {"discord", "discord server link"}, function()
	 ...
	 Notify({
	 Description = "discord.gg/9Dn6Td5xzz";
	 Title = "Named Admin";
	 Duration = 15;
	 ...
	 if httprequest then
		 httprequest({
			 ...
			 Body = HttpService:JSONEncode({
				 ...
				 args = {code = '9Dn6Td5xzz'}
			 })
		 })
	 end
	 setclipboard("discord.gg/9Dn6Td5xzz")
	 end)
...
until glueloop == false
		 ...
		 v:Disconnect()
				 ...
				 cmd.add({"prompt", "purchaseprompts"}, {"prompt (purchaseprompts)", "allows the stupid purchase prompt"}, function()
					 ...
					 game.CoreGui.PurchasePrompt.Enabled = true
								 ...
								 cmd.add({"Named"}, {"Named", "Makes your hats visible but not your name or your body"}, function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/FE/main/Named"))()
 end)
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NamedAdmin/main/Notepad"))()
 end)
...
_G.HeadSize = 10
 ...
 loadstring(game:HttpGet("https://raw.githubusercontent.com/FilteringEnabled/NamedAdmin/main/GiveHat"))()
 end)
...
game.Players.LocalPlayer.CameraMode = "LockFirstPerson"
 ...
 if table.find({Enum.Platform.IOS, Enum.Platform.Android}, game:GetService("UserInputService"):GetPlatform()) then 
	 ...
	 Notify({
	 Description = "Named Admin has detected you using mobile you now have a invisible button click it to enable / disable invisibility";
	 Title = "Named Admin";
	 Duration = 7;
	 });
 ...
 cmd.add({"httpspy"}, {"httspy", "HTTP Spy"}, function()
	 loadstring(game:HttpGet('https://raw.githubusercontent.com/FilteringEnabled/NamedAdmin/main/HttpSpy'))()
 end)
 ...
 cmd.add({"mobilelock", "mlock"}, {"mobilelock", "Shift lock for mobile yay"}, function()
-- Instances:
...
coroutine.wrap(OMQRQRC_fake_script)()
 Notify({
		 Description = "Mobile Lock Enabled!";
		 Title = "Named Admin";
		 Duration = 5;
 ...
 cmd.add({"dropbutton", "db"}, {"dropbutton", "Drop button for mobile"}, function()
   local StarterGui = game:GetService("StarterGui")
   local ScreenGui = Instance.new("ScreenGui")
   ...
   DropButton.Size = UDim2.new(0, 60, 0, 30)
